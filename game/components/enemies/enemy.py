...
from game.utils.constants import ENEMY_1, ENEMY_2, SHIP_WIDTH, SHIP_HEIGHT, SCREEN_HEIGHT, SCREEN_WIDTH
...
class Enemy(Sprite):
    ...
    def change_movement_x(self):
        ...
        elif (self.step >= self.move_x_for and self.movement_x == "left") or (self.rect.x >= SCREEN_WIDTH - SHIP_WIDTH):
